// Puedes crear este componente en src/components/WhatsappFloatButton.tsx
...
export async function WhatsappFloatButton() {
  ...
  const url = `https://wa.me/${phone}?text=${encodeURIComponent('Hola! Vengo de la web.Tengo una consulta sobre los productos.')}`;
